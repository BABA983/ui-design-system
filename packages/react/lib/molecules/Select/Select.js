...
const Select = ({ options = [], label = 'Please select an option ...', onOptionSelected: handler, renderOption, }) => {
    ...
    return (React.createElement("div", { className: "ui-select" },
        React.createElement("button", { "data-testid": "UiSelectButton", onKeyDown: onButtonKeyDown, "aria-controls": "ui-select-list", "aria-haspopup": true, "aria-expanded": isOpen ? true : undefined, ref: labelRef, className: "ui-select__label", onClick: () => onLabelClick() },
            React.createElement(Text, null, selectedOption === null ? label : selectedOption.label),
            React.createElement("svg", { className: `ui-select__caret ${isOpen ? 'ui-select__caret--open' : 'ui-select__caret--closed'}`, width: "1rem", height: "1rem", fill: "none", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, viewBox: "0 0 24 24", stroke: "currentColor" },
                React.createElement("path", { d: "M19 9l-7 7-7-7" }))),
        React.createElement("ul", { role: "menu", "aria-hidden": isOpen ? undefined : false, id: "ui-select-list", style: { top: overlayTop }, className: `ui-select__overlay ${isOpen ? 'ui-select__overlay--open' : ''}` }, options.map((option, optionIndex) => {
