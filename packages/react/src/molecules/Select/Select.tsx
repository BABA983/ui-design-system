...
const Select: React.FunctionComponent<SelectProps> = ({
  ...
  return (
    <div className="ui-select">
      <button
        data-testid="UiSelectButton"
        onKeyDown={onButtonKeyDown}
        aria-controls="ui-select-list"
        aria-haspopup={true}
      ...
      >
        ...
        <svg
          className={`ui-select__caret ${
            isOpen ? 'ui-select__caret--open' : 'ui-select__caret--closed'
          }`}
          width="1rem"
          height="1rem"
          fill="none"
...

      {
        <ul
          ...
          className={`ui-select__overlay ${
            isOpen ? 'ui-select__overlay--open' : ''
          }`}
        >
